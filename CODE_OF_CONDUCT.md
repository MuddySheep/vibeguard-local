...
pull requests, discussions, the project's documentation surfaces — and
...
be reported to the maintainers at `<TODO: conduct email — set before
public launch>`. All complaints will be reviewed and investigated
promptly and fairly.
